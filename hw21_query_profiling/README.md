...
### Запрос БЕЗ использования primary key
...
### Запрос с использованием Primary Key
...
* Отброшено 151173 из 151174 гранул.
* Прочитана 1 гранула (8192 строки).
* Выполнен range scan.
